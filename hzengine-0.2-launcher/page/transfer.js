...
let [downloadAppsideCondition, setDownloadAppsideCondition] = createSignal("等待中");
...
Page(BasePage({
    ...
    try {
      ...
      render(() => {
        return (() => {
          ...
          setProp(_el$8, "text", "状态变化测试");
          setProp(_el$8, "nc", 0x333333);
          setProp(_el$8, "pc", 0x555555);
          setProp(_el$8, "onclick", () => {
          ...
          effect(_p$ => {
            var _v$3 = EdgeInsets.symmetric({
              ...
              _v$6 = px(30),
              _v$7 = px(300),
              _v$8 = hmUI__default.text_style.WRAP,
              _v$9 = downloadAppsideProgress();
            _v$3 !== _p$.e && (_p$.e = setProp(_el$, "padding", _v$3, _p$.e));
            _v$4 !== _p$.t && (_p$.t = setProp(_el$2, "mainAxisAlignment", _v$4, _p$.t));
            _v$5 !== _p$.a && (_p$.a = setProp(_el$8, "h", _v$5, _p$.a));
            _v$6 !== _p$.o && (_p$.o = setProp(_el$8, "r", _v$6, _p$.o));
            _v$7 !== _p$.i && (_p$.i = setProp(_el$8, "w", _v$7, _p$.i));
            _v$8 !== _p$.n && (_p$.n = setProp(_el$9, "text_style", _v$8, _p$.n));
            _v$9 !== _p$.s && (_p$.s = setProp(_el$9, "text", _v$9, _p$.s));
            return _p$;
          }, {
            e: undefined,
            t: undefined,
  ...
  onReceivedFile(fileObj) {
    ...
    fileObj.on("progress", progress => {
      ...
      setDownloadAppsideProgress("" + ~~(progress.data.loadedSize * 100 / progress.data.fileSize) + "%\n" + `${progress.data.loadedSize} / ${progress.data.fileSize} Bytes`);
      asuka.refreshSync();
    });
    fileObj.on("change", event => {
      this.log("file status =>", event.data.readyState);
      setTimeout(() => setDownloadAppsideCondition(event.data.readyState), 2000);
      asuka.refreshSync();
