...
export class Fx {
     ...
     */
    constructor({ delay, begin, end, x_start, x_end, time, fx, func, fps, enable, style, onStop, Timer }) {
        if (fx) {
            // 不使用预设
            ...
            switch (style) {
                ...
                case Fx.Styles.EASE_IN_OUT_SINE:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_SINE(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_CUBIC:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_CUBIC(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_QUART:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_QUART(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_QUINT:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_QUINT(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_EXPO:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_EXPO(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_CIRC:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_CIRC(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_BACK:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_BACK(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_OUT_ELASTIC:
                    this.fx = (x) => fx_inside.EASE_OUT_ELASTIC(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                case Fx.Styles.EASE_IN_OUT_ELASTIC:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_ELASTIC(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
                ...
                case Fx.Styles.EASE_IN_OUT_BOUNCE:
                    this.fx = (x) => fx_inside.EASE_IN_OUT_BOUNCE(x, begin, end, fps * time);
                    this.x_start = 0;
                    this.x_end = fps * time;
                    this.speed = 1;
                    break;
    ...
    static getMixColor(color1, color2, percentage) {
        let r0 = color1 & 0xff0000, g0 = color1 & 0x00ff00, b0 = color1 & 0x0000ff;
        let r1 = color2 & 0xff0000, g1 = color2 & 0x00ff00, b1 = color2 & 0x0000ff;
        ...
        function math_func(x) {
            return x === 0
                ...
                : x === 1
                    ...
                    : x < 0.5
                        ? -(Math.pow(2, 20 * x - 10) *
                            sin(((20 * x - 11.125) * (2 * Math.PI)) / 4.5)) / 2
                        : (Math.pow(2, -20 * x + 10) *
