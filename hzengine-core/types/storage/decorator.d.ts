 ...
 * @returns
 */
export declare function ArchiveStateAccessor<This extends {
    _core: HZEngineCore;
 ...
 * @returns
 */
export declare function ArchiveStateAccessorWithSerializer<This extends {
    _core: HZEngineCore;
...
export declare function ArchiveStateGetter<This extends {
    _core: HZEngineCore;
...
export declare function ArchiveStateGetterWithSerializer<This extends {
    _core: HZEngineCore;
 ...
 * @returns
 */
export declare function ArchiveStateSetter<This extends {
    _core: HZEngineCore;
...
export declare function ArchiveStateSetterWithDeserializer<This extends {
    _core: HZEngineCore;
