...
let Script = (() => {
    ...
    return _a = class Script {
            constructor(_core) {
                 ...
                 */
                this._callStack = __runInitializers(this, __callStack_initializers, []);
                /**
                 * 语句栈
                 * 比如while, if，会在语句开始时入栈，语句结束时出栈
                 */
                this._statementStack = __runInitializers(this, __statementStack_initializers, []);
                /**
                 * 下一次执行的脚本位置
                 * 注意：存储该值的时候应总是拷贝赋值而非直接引用赋值
                 */
                this._nextRunPosition = __runInitializers(this, __nextRunPosition_initializers, null);
                // Middleware
                this._middlewares = [];
                // Statement Analyse
        ...
        (() => {
            ...
            __callStack_decorators = [ArchiveState];
            __statementStack_decorators = [ArchiveState];
            __nextRunPosition_decorators = [ArchiveState];
            __esDecorate(null, null, __callStack_decorators, { kind: "field", name: "_callStack", static: false, private: false, access: { has: obj => "_callStack" in obj, get: obj => obj._callStack, set: (obj, value) => { obj._callStack = value; } }, metadata: _metadata }, __callStack_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, __statementStack_decorators, { kind: "field", name: "_statementStack", static: false, private: false, access: { has: obj => "_statementStack" in obj, get: obj => obj._statementStack, set: (obj, value) => { obj._statementStack = value; } }, metadata: _metadata }, __statementStack_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, __nextRunPosition_decorators, { kind: "field", name: "_nextRunPosition", static: false, private: false, access: { has: obj => "_nextRunPosition" in obj, get: obj => obj._nextRunPosition, set: (obj, value) => { obj._nextRunPosition = value; } }, metadata: _metadata }, __nextRunPosition_initializers, _instanceExtraInitializers);
