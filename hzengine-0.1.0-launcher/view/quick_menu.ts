...
export class QuickMenu extends UI.View<QuickMenuViewProp> {
        ...
        hmUI.widget.BUTTON,
        {
          ...
          click_func: () => {
            ...
            try {
              ...
              this.core.debug.log(`quick save failed, error: \n${e}`);
              throw e;
            }
        ...
        hmUI.widget.BUTTON,
        {
          ...
          click_func: () => {
            ...
            try {
              ...
              this.core.debug.log(`quick load failed, error: \n${e}`);
              throw e;
            }
  ...
  onCommit(prop: QuickMenuViewProp): void {}
  onDestroy(): void {
...
export interface QuickMenuViewProp {}
